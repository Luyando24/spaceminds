export const projects = [
  ...
  {
    client: "Zambian Government (Proposal)",
    project: "Zamportal Companion",
    type: "GovTech / Concept",
    impact: "A concept and project proposal to the Zambian Government for a secure digital gateway companion to access public services, apply for documents, and pay fees online 24/7.",
    year: "2024",
  ...
  {
    client: "Sinoway Education",
    project: "Sinoedu Portal",
    type: "EdTech / Admissions",
    impact: "An international educational consultancy portal facilitating CSC scholarships and Chinese university admissions, offering multilingual support and streamlined student applications.",
    year: "2024",
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=2000",
    url: "https://www.sinowayedu.com/en"
  }
];
